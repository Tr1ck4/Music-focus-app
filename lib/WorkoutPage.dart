...
class WorkoutPage extends StatefulWidget {
  ...
  List<Song>liked = [];
  List<Song>added = [];
  WorkoutPage({super.key,required this.audioPlayer,required this.meditation,required this.study,required this.workout, required this.sleep, required this.added,required this.liked});
  @override
...
class _WorkoutPageState extends State<WorkoutPage> {
  ...
  void initState() {
    ...
    widget.audioPlayer.onPlayerComplete.listen((event) {
      ...
      widget.audioPlayer.play(AssetSource(widget.workout[index].asset));
    });
    startTimer();
  }

  Future<void> setAudio() async {
    widget.audioPlayer.setSourceAsset(widget.workout[index].asset);
  }
